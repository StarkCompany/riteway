<?php
// Brokerage Signs Taken Down for Selected Realtor
?>
<?php get_header(); ?>
                ...
                <?php if ( is_user_logged_in() ) { ?>
						...
						<div id="main" class="m-all t-2of3 d-5of7 cf" role="main">
							...
							<article id="post-<?php the_ID(); ?>" <?php post_class( 'cf' ); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
								...
								<section>
                                	<h2>Select a sign that has been taken down</h2>
    	                            <?php echo sign_down_selected_realtor_dropdown( 'signs' ) ?>
                                </section>
                                <section class="report">
                            	    <?php include('reports/brokerage-single-user-signs-down.php'); ?>
                                </section>
