            ...
            <div id="content-top">
            	<div class="wrap cf">
                    ...
                    <div class="main-login">
                    	<div class="login-title m-all t-1of2 d-1of2">
	                        <h2>Welcome to Riteway Signs</h2>
                        </div>
                        <div class="login-content m-all t-1of2 d-1of2">
							<?php
                            ...
                            <?php } else { ?>
                                ...
                                <div class="password-content">
                                    <a href="<?php echo home_url(); ?>/wp-login.php?action=register">Need Password?</a>
                                    <a href="<?php echo home_url(); ?>/wp-login.php?action=lostpassword">Lost Password?</a>
                                </div>
                            <?php }
                            ?>
                        </div>
