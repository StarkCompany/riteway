        ...
        foreach ( $_POST['wpuf_input'] as $key => $field_val ) {
            if ( array_key_exists( 'options', $field_val) ) {
                foreach ( $field_val['options'] as $options_key => $options_value ) {
                    ...
                    $view_option[$key][$opt_value] = $options_value;//$view_option[$opt_value] = $options_value;//$_POST['wpuf_input'][$key]['options'][$opt_value] = $options_value;
                }
                unset($_POST['wpuf_input'][$key]['options_values']);
                $_POST['wpuf_input'][$key]['options'] = $view_option[$key];//$_POST['wpuf_input']['options'] = $view_option;
            }
